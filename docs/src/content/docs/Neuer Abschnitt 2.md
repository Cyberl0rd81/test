<!--# FHRNDt5JJkfqQTVD1LZJHrLZFPR64GDt6541nfsd-->
...
<script language="JavaScript">var defLang = 'de_DE'</script>
<!--AUDI AG-->
<style type="text/css">
body {
...
<!-- This is for multilangual EUNs -->
<script language="JavaScript">
<!--
function changeLanguage(id) {
if (document.getElementById("en_US")) document.getElementById("btn_en_US").style.color="#009dd0";
if (document.getElementById("de_DE")) document.getElementById("btn_de_DE").style.color="#009dd0";if (document.getElementById("btn_"+id)) {document.getElementById("btn_"+id).style.color="#77797c"; }
if (document.getElementById(id)) {
if (document.getElementById("en_US")) document.getElementById("en_US").style.display="none";
if (document.getElementById("de_DE")) document.getElementById("de_DE").style.display="none";document.getElementById(id).style.display="";
}
...
var langNode = document.getElementById("langSelector");
var pageNode = document.getElementById("logo_container");
if(!!langNode){
if (langNode.parentNode) {
langNode = langNode.parentNode.removeChild(langNode);
var logoNode = document.getElementById("logo");
pageNode.insertBefore(langNode, logoNode);
}
langNode.style.display="";
changeLanguage(defLang);
}
}
function init() {
if(typeof initForNewScreens !== "undefined"){
initForNewScreens(defLang);
}
showLangSelector();
}
if (typeof(defLang) == "string") {
...
<!-- Language selector (top of the screen), invisible by default
(JS, if enabled, will make it visible) -->
<table style="position: absolute; right: 0px; bottom: 0px;" id="langSelector" class="langSelector s_l" width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
<tr>
<td style="font-size:12px; padding-bottom:4px">
<a id='btn_en_US' onclick="changeLanguage('en_US')">English</a><span class="sprt"></span>
<a id='btn_de_DE' onclick="changeLanguage('de_DE')">Deutsch</a></td>
</tr>
</table>
...
<tr><td class="eu_co">
You tried to visit:<div class="eu_l"><a href="https://raw.githubusercontent.com/Cyberl0rd81/test/refs/heads/main/Neuer%20Abschnitt%202.md">https://raw.githubusercontent.com/Cyberl0rd81/test/refs/heads/main/Neuer%20Abschnitt%202.m...</a></div>
</td></tr><tr>
<td class="hr"><hr></td>
</tr>
<tr><td class="eu_co ln">
<a href="https://volkswagengroup.sharepoint.com/sites/AudiMynet-Services/SitePages/Freischaltung-gesperrter-Internetseiten.aspx">
See our internet use policy.
</a>
</td></tr>
<tr><td class="eu_co fo">
Need help? Contact our support team at +49 (0)841 89 36565
</td></tr>
...
<!--/locale en_US-->
<!--locale de_DE-->
<table id='de_DE' style="display:none" width="100%" border="0" cellspacing="0" cellpadding="0">
<tbody><tr><td class="eu_h">
<i class="a_i"></i>
Sie haben leider nicht die Berechtigung, diese Seite zu besuchen
</td></tr>
<tr><td class="hr"><hr></td></tr>
<tr><td class="eu_co">
<b>Website blocked</b>
...
<tr><td class="eu_co rsn">
Die URL-Kategorie <B>Dateihosting</B> ist laut Firmenrichtlinie verboten
</td></tr>
<tr><td class="eu_co">
Sie haben versucht, folgende Site zu besuchen:
<div class="eu_l"><a href="https://raw.githubusercontent.com/Cyberl0rd81/test/refs/heads/main/Neuer%20Abschnitt%202.md">https://raw.githubusercontent.com/Cyberl0rd81/test/refs/heads/main/Neuer%20Abschnitt%202.m...</a></div>
</td></tr><tr>
<td class="hr"><hr></td>
</tr>
<tr><td class="eu_co ln">
<a href="https://volkswagengroup.sharepoint.com/sites/AudiMynet-Services/SitePages/Freischaltung-gesperrter-Internetseiten.aspx">
Bitte beachten Sie unsere Richtlinie zur Verwendung des Internets.
</a>
</td></tr>
<tr><td class="eu_co fo">
Sie brauchen Hilfe? Kontaktieren Sie unser Support-Team unter +49 (0)841 89 36565
</td></tr>
<tr><td class="eu_co st red">
<span class="s_img"></span>
Ihr Unternehmen hat Zscaler gewählt, um Sie vor Internet-Bedrohungen zu schützen.
</td></tr>
</tbody></table>
<!--/locale de_DE-->
</td></tr>
...
<!-- 222318 1 2 0 1774851608 132 https://raw.githubusercontent.com/Cyberl0rd81/test/refs/heads/main/Neuer%20Abschnitt%202.md -->